...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "request_queue *", "q", q, "bio *", "bio", bio);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "bool", "factory_init", factory_init);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_geo *", "geo", geo, "nvm_addrf_12 *", "dst", dst);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "nvm_geo *", "geo", geo, "nvm_addrf *", "adst", adst, "pblk_addrf *", "udst", udst);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 0);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_line_mgmt *", "l_mg", l_mg, "pblk_line *", "line", line);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "int", "nr_free_chks", nr_free_chks);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct pblk_line_mgmt *l_mg = &pblk->l_mg;
	struct pblk_line_meta *lm = &pblk->lm;
	struct nvm_geo *geo = &dev->geo;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "nvm_chk_meta *", "meta", meta);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
	struct pblk_line_meta *lm = &pblk->lm;
	int i, nr_bad_chks = 0;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "void *", "chunk_meta", chunk_meta, "int", "line_id", line_id);
	struct pblk_line_mgmt *l_mg = &pblk->l_mg;
	struct pblk_line_meta *lm = &pblk->lm;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "bool", "graceful", graceful);
	if (graceful)
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "void *", "private", private, "bool", "graceful", graceful);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "void *", "private", private);
	struct pblk *pblk = private;
...
static void *pblk_init(struct nvm_tgt_dev *dev, struct gendisk *tdisk,
		       int flags)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "nvm_tgt_dev *", "dev", dev, "gendisk *", "tdisk", tdisk, "int", "flags", flags);
	CPS_MSG("PBLK INIT");
