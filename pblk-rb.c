...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "pblk_rb *", "rb", rb);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "unsigned int", "nr_entries", nr_entries, "unsigned int", "threshold", threshold);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk_rb *", "rb", rb, "unsigned int", "size", size, "unsigned int", "threshold", threshold, "unsigned int", "seg_size", seg_size);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "pblk_w_ctx *", "w_ctx", w_ctx);
	int flags;
...
unsigned int pblk_rb_ptr_wrap(struct pblk_rb *rb, unsigned int p,
			      unsigned int nr_entries)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk_rb *", "rb", rb, "unsigned int", "p", p, "unsigned int", "nr_entries", nr_entries);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_rb *", "rb", rb, "unsigned int", "nr_entries", nr_entries);
	unsigned int subm;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_rb *", "rb", rb, "unsigned int", "to_update", to_update);
	struct pblk *pblk = container_of(rb, struct pblk, rwb);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk_rb *", "rb", rb, "unsigned int", "nr_entries", nr_entries, "unsigned int", "mem", mem, "unsigned int", "sync", sync);
...
static void __pblk_rb_write_entry(struct pblk_rb *rb, void *data,
				  ...
				  struct pblk_rb_entry *entry)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk_rb *", "rb", rb, "void *", "data", data, "pblk_w_ctx", "w_ctx", w_ctx, "pblk_rb_entry *", "entry", entry);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk_rb *", "rb", rb, "void *", "data", data, "pblk_w_ctx", "w_ctx", w_ctx, "unsigned int", "ring_pos", ring_pos);
	struct pblk *pblk = container_of(rb, struct pblk, rwb);
	struct pblk_rb_entry *entry;
	int flags;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 6, "pblk_rb *", "rb", rb, "void *", "data", data, "pblk_w_ctx", "w_ctx", w_ctx, "pblk_line *", "line", line, "u64", "paddr", paddr, "unsigned int", "ring_pos", ring_pos);
	struct pblk *pblk = container_of(rb, struct pblk, rwb);
	struct pblk_rb_entry *entry;
	int flags;
...
static int pblk_rb_flush_point_set(struct pblk_rb *rb, struct bio *bio,
				   unsigned int pos)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk_rb *", "rb", rb, "bio *", "bio", bio, "unsigned int", "pos", pos);
	struct pblk_rb_entry *entry;
...
static int __pblk_rb_may_write(struct pblk_rb *rb, unsigned int nr_entries,
			       unsigned int *pos)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk_rb *", "rb", rb, "unsigned int", "nr_entries", nr_entries, "unsigned int *", "pos", pos);
	unsigned int mem;
	unsigned int sync;
	unsigned int threshold;
...
static int pblk_rb_may_write_flush(struct pblk_rb *rb, unsigned int nr_entries,
				   ...
				   int *io_ret)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 5, "pblk_rb *", "rb", rb, "unsigned int", "nr_entries", nr_entries, "unsigned int *", "pos", pos, "bio *", "bio", bio, "int *", "io_ret", io_ret);
	unsigned int mem;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk_rb *", "rb", rb, "bio *", "bio", bio, "unsigned int", "nr_entries", nr_entries, "unsigned int *", "pos", pos);
	struct pblk *pblk = container_of(rb, struct pblk, rwb);
	int io_ret;
...
unsigned int pblk_rb_read_to_bio(struct pblk_rb *rb, struct nvm_rq *rqd,
				 ...
				 unsigned int count)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 5, "pblk_rb *", "rb", rb, "nvm_rq *", "rqd", rqd, "unsigned int", "pos", pos, "unsigned int", "nr_entries", nr_entries, "unsigned int", "count", count);
	struct pblk *pblk = container_of(rb, struct pblk, rwb);
...
int pblk_rb_copy_to_bio(struct pblk_rb *rb, struct bio *bio, sector_t lba,
			struct ppa_addr ppa)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk_rb *", "rb", rb, "bio *", "bio", bio, "sector_t", "lba", lba, "ppa_addr", "ppa", ppa);
	struct pblk *pblk = container_of(rb, struct pblk, rwb);
	struct pblk_rb_entry *entry;
	struct pblk_w_ctx *w_ctx;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_rb *", "rb", rb, "unsigned int", "pos", pos);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_rb *", "rb", rb, "u64", "pos", pos);
	return (pos >= rb->nr_entries);
}

ssize_t pblk_rb_sysfs(struct pblk_rb *rb, char *buf)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_rb *", "rb", rb, "char *", "buf", buf);
	struct pblk *pblk = container_of(rb, struct pblk, rwb);
	struct pblk_c_ctx *c;
	ssize_t offset;
