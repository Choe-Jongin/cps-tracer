...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "bio *", "bio", bio, "sector_t", "lba", lba, "ppa_addr", "ppa", ppa);
...
static int pblk_read_ppalist_rq(struct pblk *pblk, struct nvm_rq *rqd,
				 ...
				 bool *from_cache)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 5, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "bio *", "bio", bio, "sector_t", "blba", blba, "bool *", "from_cache", from_cache);
...
static void pblk_read_check_seq(struct pblk *pblk, struct nvm_rq *rqd,
				sector_t blba)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "sector_t", "blba", blba);
	void *meta_list = rqd->meta_list;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "u64 *", "lba_list", lba_list, "int", "nr_lbas", nr_lbas);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "bio *", "bio", bio, "int", "error", error);
...
static void __pblk_end_io_read(struct pblk *pblk, struct nvm_rq *rqd,
			       bool put_line)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "bool", "put_line", put_line);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 5, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "bio *", "bio", bio, "sector_t", "lba", lba, "bool *", "from_cache", from_cache);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 6, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "pblk_line *", "line", line, "u64 *", "lba_list", lba_list, "u64 *", "paddr_list_gc", paddr_list_gc, "unsigned int", "nr_secs", nr_secs);
...
static int read_rq_gc(struct pblk *pblk, struct nvm_rq *rqd,
		      ...
		      u64 paddr_gc)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 5, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "pblk_line *", "line", line, "sector_t", "lba", lba, "u64", "paddr_gc", paddr_gc);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "pblk_gc_rq *", "gc_rq", gc_rq);
	struct nvm_rq rqd;
	int ret = NVM_IO_OK;
