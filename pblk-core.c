...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "work_struct *", "work", work);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "ppa_addr", "ppa_addr", ppa_addr);
	struct nvm_tgt_dev *dev = pblk->dev;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "nvm_rq *", "rqd", rqd);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "pblk *", "pblk", pblk);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
...
struct nvm_chk_meta *pblk_chunk_get_off(struct pblk *pblk,
					      ...
					      struct ppa_addr ppa)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_chk_meta *", "meta", meta, "ppa_addr", "ppa", ppa);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
...
void __pblk_map_invalidate(struct pblk *pblk, struct pblk_line *line,
			   u64 paddr)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "u64", "paddr", paddr);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "ppa_addr", "ppa", ppa);
	struct pblk_line *line;
	u64 paddr;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "sector_t", "slba", slba, "unsigned int", "nr_secs", nr_secs);
	sector_t lba;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "int", "type", type);
	mempool_t *pool;
	struct nvm_rq *rqd;
	int rq_size;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "int", "type", type);
	mempool_t *pool;
...
void pblk_bio_free_pages(struct pblk *pblk, struct bio *bio, int off,
			 int nr_pages)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "bio *", "bio", bio, "int", "off", off, "int", "nr_pages", nr_pages);
	struct bio_vec *bv;
	struct page *page;
	int i, e, nbv = 0;
...
int pblk_bio_add_pages(struct pblk *pblk, struct bio *bio, gfp_t flags,
		       int nr_pages)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "bio *", "bio", bio, "gfp_t", "flags", flags, "int", "nr_pages", nr_pages);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "timer_list *", "t", t);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "pblk_line *", "line", line);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "bio *", "bio", bio);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "int", "sec_per_write", sec_per_write);
	pblk->sec_per_write = sec_per_write;
}

int pblk_submit_io(struct pblk *pblk, struct nvm_rq *rqd, void *buf)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "void *", "buf", buf);
	struct nvm_tgt_dev *dev = pblk->dev;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "unsigned long", "secs_avail", secs_avail, "unsigned long", "secs_to_flush", secs_to_flush, "bool", "skip_meta", skip_meta);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "int", "nr_secs", nr_secs);
	u64 addr;
	int i;
...
int pblk_line_emeta_read(struct pblk *pblk, struct pblk_line *line,
			 void *emeta_buf)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "void *", "emeta_buf", emeta_buf);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
	struct pblk_line_meta *lm = &pblk->lm;
...
static void pblk_setup_e_rq(struct pblk *pblk, struct nvm_rq *rqd,
			    struct ppa_addr ppa)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "ppa_addr", "ppa", ppa);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk_line *", "line", line, "pblk_line_mgmt *", "l_mg", l_mg, "pblk_line_meta *", "lm", lm);
	int meta_line;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "pblk_line *", "cur", cur);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
	struct pblk_line_meta *lm = &pblk->lm;
	struct pblk_line_mgmt *l_mg = &pblk->l_mg;
...
static int pblk_line_init_bb(struct pblk *pblk, struct pblk_line *line,
			     int init)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "int", "init", init);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
	struct pblk_line_meta *lm = &pblk->lm;
	struct pblk_line_mgmt *l_mg = &pblk->l_mg;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "pblk_line *", "line", line);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "kref *", "ref", ref);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 6, "pblk *", "pblk", pblk, "pblk_line *", "line", line, "void *", "priv", priv, "void", "(*work)(struct work_struct *)", work, "gfp_t", "gfp_mask", gfp_mask, "workqueue_struct *", "wq", wq);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "int", "pos", pos);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "ppa_addr", "ppa", ppa, "unsigned long *", "lun_bitmap", lun_bitmap);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
	int pos = pblk_ppa_to_pos(geo, ppa);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "unsigned long *", "lun_bitmap", lun_bitmap);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
	struct pblk_lun *rlun;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "sector_t", "lba", lba, "ppa_addr", "ppa", ppa);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 5, "pblk *", "pblk", pblk, "sector_t", "lba", lba, "ppa_addr", "ppa_new", ppa_new, "pblk_line *", "gc_line", gc_line, "u64", "paddr_gc", paddr_gc);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "sector_t", "lba", lba, "ppa_addr", "ppa_mapped", ppa_mapped, "ppa_addr", "ppa_cache", ppa_cache);
	struct ppa_addr ppa_l2p;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 5, "pblk *", "pblk", pblk, "ppa_addr *", "ppas", ppas, "sector_t", "blba", blba, "int", "nr_secs", nr_secs, "bool *", "from_cache", from_cache);
	int i;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "ppa_addr *", "ppas", ppas, "u64 *", "lba_list", lba_list, "int", "nr_secs", nr_secs);
	u64 lba;
	int i;
