...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "pblk_rl *", "rl", rl);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_rl *", "rl", rl, "int", "nr_entries", nr_entries);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk_rl *", "rl", rl, "int", "nr_user", nr_user, "int", "nr_gc", nr_gc);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_rl *", "rl", rl, "unsigned long", "free_blocks", free_blocks);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk_rl *", "rl", rl, "pblk_line *", "line", line);
...
void pblk_rl_free_lines_dec(struct pblk_rl *rl, struct pblk_line *line,
			    bool used)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk_rl *", "rl", rl, "pblk_line *", "line", line, "bool", "used", used);
	int blk_in_line = atomic_read(&line->blk_in_line);
	int free_blocks;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk_rl *", "rl", rl, "int", "budget", budget, "int", "threshold", threshold);
	struct pblk *pblk = container_of(rl, struct pblk, rl);
