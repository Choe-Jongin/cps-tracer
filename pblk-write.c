...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "pblk_c_ctx *", "c_ctx", c_ctx);
...
static void pblk_map_remaining(struct pblk *pblk, struct ppa_addr *ppa,
		int rqd_ppas)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "ppa_addr *", "ppa", ppa, "int", "rqd_ppas", rqd_ppas);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "unsigned int", "sentry", sentry, "unsigned int", "nr_entries", nr_entries);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "pblk_c_ctx *", "c_ctx", c_ctx);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 4, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "unsigned int", "nr_secs", nr_secs, "nvm_end_io_f", "(*end_io)", end_io);
	/* Setup write request */
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "nvm_rq *", "rqd", rqd, "ppa_addr *", "erase_ppa", erase_ppa);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "unsigned int", "secs_avail", secs_avail, "unsigned int", "secs_to_flush", secs_to_flush);
	int secs_to_sync;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "pblk_line *", "meta_line", meta_line);
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 3, "pblk *", "pblk", pblk, "pblk_line *", "meta_line", meta_line, "nvm_rq *", "data_rqd", data_rqd);
	struct nvm_tgt_dev *dev = pblk->dev;
	struct nvm_geo *geo = &dev->geo;
...
static struct pblk_line *pblk_should_submit_meta_io(struct pblk *pblk,
						    struct nvm_rq *data_rqd)
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "nvm_rq *", "data_rqd", data_rqd);
	struct pblk_line_meta *lm = &pblk->lm;
	struct pblk_line_mgmt *l_mg = &pblk->l_mg;
	struct pblk_line *meta_line;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 2, "pblk *", "pblk", pblk, "int *", "secs_left", secs_left);
	struct bio *bio;
	struct nvm_rq *rqd;
...
{
	CPS_FUNCTION(CPS_CALLER, CPS_CALLEE, __FILE__, __func__, 1, "void *", "data", data);
